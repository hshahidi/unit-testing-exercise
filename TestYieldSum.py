import pytest
import YieldAverage
from YieldAverage import wafer_yield_sum
...
def test_sum_should_return_rounded_sum():
...
def test_sum_should_return_round_down_sum():
...
def test_sum_should_return_round_up_sum():
